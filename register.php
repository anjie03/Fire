    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-gradient-primary bg-register-image">
                       <img src="img/bfp.png" alt=""
                        style="width: 35%; margin-left: auto; margin-right: auto; display: block; margin-top: 45%;" >
                        <p 
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
		                    ...
		                    <?php } ?>
                            <form action="d_register.php" class="user" method="post">
                                ...
                                <button class="btn btn-user btn-primary btn-block" >Register Account</button>
                                <hr>
